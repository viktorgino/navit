                                     ...
                                     struct fibheap *heap)
{
    ...
    { /* Iterate over all the segments leading away from our point */
    ...
    { /* Iterate over all the segments leading towards our point */
                                                  ...
                                                  struct item *item)
{
    ...
    if (s_pnt && e_pnt)
    {
        ...
        size = sizeof(struct route_graph_segment) - sizeof(struct route_segment_data) + route_segment_data_size(found->data.flags);
...
{
    plugin_register_category(plugin_category_map, "route", route_map_new);
    plugin_register_category(plugin_category_map, "route_graph", route_graph_map_new);
}
